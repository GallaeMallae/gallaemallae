    ...
    <section>
      ...
      <div className="flex justify-between md:grid md:grid-cols-5 md:gap-4">
        {CATEGORY_MENU.map((category) => {
          ...
          return (
            <Link key={id} href={`/map?category=${id}`} className="block">
              <Card className="cursor-pointer border-none bg-transparent py-0 shadow-none md:rounded-xl md:border md:bg-white md:py-6 md:shadow-sm">
