...
import EventDetailModalLeftTest from "@/components/modal/EventDetailModalLeftTest";
import EventDetailModalRightTest from "@/components/modal/EventDetailModalRightTest";
...
export default function EventDetailModalTest({ event, open, onClose }: Props) {
        ...
        <div className="flex flex-col gap-6 p-8 md:p-8">
          ...
          <div className="flex flex-col gap-8 md:flex-row">
            <div className="w-full shrink-0 md:w-[320px]">
              <EventDetailModalLeftTest event={event} />
            </div>

            <div className="flex-1">
              <EventDetailModalRightTest event={event} />
            </div>
          </div>
        </div>
      </DialogContent>
